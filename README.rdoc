...
If the script detects that the browser doesn't support <tt><input type="number"></tt>, it will search for these elements and attach some Javascript to them to make them function as number-only input fields, and add increment/decrement buttons.
