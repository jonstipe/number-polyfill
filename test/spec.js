...
(function() {
  (function($) {
    $(function() {
      var $downBtn, $numberField, $upBtn, ui, vals;
      ui = {
      ...
      test("adds the increment and decrement buttons after the field", 2, function() {
        equal($upBtn.length, 1, "Increment button is added.");
        equal($downBtn.length, 1, "Decrement button is added.");
      });
      test("doesn't allow non-numeric values", 2, function() {
        $numberField.val("0");
      ...
      test("allows deleting min", 2, function() {
      ...
      test("allows changing max", function() {
      ...
      test("allows deleting max", function() {
      ...
      test("constrains values with the step attribute", function() {
      ...
      test("increments the value on mousewheel up", 1001, function() {
        var i, _i;
        $numberField.val("0");
      ...
      test("decrements the value on mousewheel down", 1001, function() {
        var i, _i;
        $numberField.val("0");
        $numberField.attr("step", "0.001");
      ...
      module("upBtn");
      test("increments the value when clicked", 1001, function() {
        var i, _i;
        $numberField.val("0");
        $numberField.attr("step", "0.001");
        for (i = _i = 0; _i <= 1000; i = ++_i) {
      ...
      module("downBtn");
      test("decrements the value when clicked", 1001, function() {
        var i, _i;
        for (i = _i = 1000; _i >= 0; i = --_i) {
          ui.click($downBtn);
          equal($numberField.val(), vals[i], "");
