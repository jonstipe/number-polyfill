...
describe "number-polyfill", ->
  ...
  it "adds the increment and decrement buttons after the field", ->
    expect($upBtn.length).toEqual(1)
    expect($downBtn.length).toEqual(1)
    return

  it "doesn't allow non-numeric values", ->
    $numberField.val("0")
  ...
  it "doesn't allow values lower than min", ->
    $numberField.attr("min", "10")
    $numberField.val("5")
    expect($numberField.val()).toEqual("5")
    return

  it "allows changing min", ->
    $numberField.attr("min", "10")
    $numberField.val("15")
  ...
  it "doesn't allow values higher than max", ->
    $numberField.attr("max", "100")
    $numberField.val("110")
    expect($numberField.val()).toEqual("100")
    return

  it "allows changing max", ->
  ...
  it "constrains values with the step attribute", ->
  ...
  it "increments the value on mousewheel up", ->
    $numberField.val("0")
  ...
  it "decrements the value on mousewheel down", ->
    for i in [1000..0]
  ...
  describe "upBtn", ->
    it "increments the value when clicked", ->
      $numberField.val("0")
      $numberField.attr("step", "0.001")
      for i in [0..1000]
        ui.click($upBtn)
  ...
  describe "downBtn", ->
    it "decrements the value when clicked", ->
      for i in [1000..0]
        ui.click($downBtn)
        expect($numberField.val()).toEqual(vals[i])
      return
